...
class DiffMatchPatch {
  ...
  int _match_bitap(String text, String pattern, int loc) {
    //Expect.isTrue(Match_MaxBits == 0 || pattern.length <= Match_MaxBits, 'Pattern too long for this application.');
    ...
    for (var x = 0; x < patches.length; x++) {
      ...
      while (!bigpatch.diffs.isEmpty) {
        ...
        while (!bigpatch.diffs.isEmpty &&
          ...
          Diff diff_type = bigpatch.diffs[0];
          ...
          if (diff_type == Operation.insert) {
            ...
            empty = false;
            patch.diffs.add(new Diff(diff_type.operation, diff_text));
            bigpatch.diffs.removeAt(0);
          } else {
